...
Query detailed information of Kafka consumer groups, including topic, partition, offset, lag, etc.

### Command Parameters

```bash
-b|--bootstrap-server=string    Kafka service address. Example: anet-master:22012
-a|--all-groups=flag            Query all consumer groups
-t|--timeout=integer            Timeout (milliseconds). Example: 30000
-c|--command-config=string      Configuration file path. Example: /sf/cfg/vn/kafka/client-ssl.properties
```
